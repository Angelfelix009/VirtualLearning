    ...
    <div>
		...
		$name=$rows["surname"];
				$oname=$rows["othernames"];
					 ...
					 echo $name. ' '. $oname;} ?> <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                                             
                        <li id='change_data_student'>
            ...
            <div class="sidebar-nav navbar-collapse" style="color:#FFF;">
                <ul class="nav" id="side-menu" style="color:#FFF;">
                    <li>
					<a href="student_profile.php"><i class="fa fa-fw fa-dashboard"></i>Student Dashboard</a>
                    </li>
                    <li>
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-gear"></i> Profile Setup</a>
                        <ul class="nav nav-second-level">
                        <li id="viewprofile">
                        <a href="#">View Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li id='update_student'>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-gear"></i> Material Download</a>
                        <ul class="nav nav-second-level">
                        <li id='download_ebook'>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-gear"></i> Other Material Download</a>
                        <ul class="nav nav-second-level">
                        <li id='download_oebook'>
                        <a href="#">Download Ebook</a>
                        </li>
                        <li class="divider"></li>
                        <li id='download_ovideo'>
                        <a href="#">Download Video</a>
                        </li>
                        </ul>
                    </li>
